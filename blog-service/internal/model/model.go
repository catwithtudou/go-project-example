...
type Model struct {
	...
	CreatedOn  uint32 `json:"created_on,omitempty"`  //创建时间
	ModifiedOn uint32 `json:"modified_on,omitempty"` //修改时间
	DeletedOn  uint32 `json:"deleted_on,omitempty"`  //删除时间
	IsDel      uint8  `json:"is_del,omitempty"`      //删除状态：0：未删除 1：已删除
}
